      ...
      <div className="hidden lg:flex lg:w-[52%] relative flex-col justify-between p-14 overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-[11px] tracking-eyebrow uppercase text-accent font-medium">New Member Registration</span>
          </div>
          <h2 className="font-display text-5xl xl:text-6xl text-ivory font-light leading-[1.0] tracking-display mb-6">
            Your practice,
            <br />
            <em className="text-gradient-gold font-normal italic">streamlined.</em>
          </h2>
          <p className="text-ivory/70 text-base leading-relaxed max-w-sm">
            One account connects you to document preparation, remuneration tracking, and committee approvals — all in one place built for NBA members.
          </p>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-8 py-12">
          <div className="w-full max-w-sm">
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-[11px] tracking-eyebrow uppercase text-accent font-semibold">New Member Registration</span>
            </div>

            <h1 className="font-display text-4xl font-light text-primary tracking-display leading-[1.05] mb-2">
              Create your account.
            </h1>
            <p className="text-muted-foreground text-sm mb-8">Register to access the NBA Remuneration Portal.</p>
