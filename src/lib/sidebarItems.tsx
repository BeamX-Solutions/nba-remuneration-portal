import { FileText, CreditCard, Home, FolderOpen, Search, BookMarked, Scale, Calculator } from "lucide-react";
...
export const sidebarItems = [
  ...
  { label: "Fee Calculator", href: "/dashboard/fees", icon: <Calculator className="h-4 w-4" /> },
