  ...
  <footer className="bg-primary text-primary-foreground">
    <div className="container py-12 md:py-16">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-1">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="font-heading font-bold text-primary-foreground leading-tight">NBA Remuneration</p>
              <p className="text-[10px] text-primary-foreground/50 tracking-wide">Legal Document Portal</p>
            </div>
          </div>
          <p className="text-sm text-primary-foreground/60 leading-relaxed">
            The NBA Remuneration Portal — a dedicated platform for legal practitioners to prepare, manage, and track legal documents with full administrative oversight.
          </p>
            ...
            {[
              ...
              <li key={l.label}>
                {l.to ? (
                  ...
                  <a href={l.href} className="text-sm text-primary-foreground/60 hover:text-primary-foreground transition-colors">
                    {l.label}
                  </a>
                )}
              </li>
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-primary-foreground/80">remuneration@nbaanaocha.org.ng</p>
        ...
        <div>
          ...
          <p className="text-sm text-primary-foreground/60 mb-5 leading-relaxed">
            Verified NBA members can sign in to prepare documents, track approvals, and manage their remuneration records.
          </p>
      ...
      <div className="border-t border-primary-foreground/15 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-primary-foreground/40">
        <p>© {new Date().getFullYear()} Nigerian Bar Association — Remuneration Committee. All Rights Reserved.</p>
        <p>Promoting legal compliance and professional standards.</p>
      </div>
    </div>
  </footer>
);
